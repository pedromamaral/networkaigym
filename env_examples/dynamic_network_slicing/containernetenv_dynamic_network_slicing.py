...
class ContainernetEnv(Env):
    def __init__(self):
        ...
        # define Action Space
        self.action_space = spaces.Discrete(OUTPUT_DIM)
    ...
    def upload_starting_rules(self):
        ...
        for bs in base_stations:
            ...
            for cs in computing_stations:
                    ...
                    path= self.get_higher_bottleneck_path(self.graph, bs, cs, PATHS)
                    ...
                    path = self.get_higher_bottleneck_path(self.graph, cs, bs, PATHS)
